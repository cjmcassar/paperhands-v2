...
const Auth: NextPage = () => {
  return (
    <button
      className="cursor-pointer [border:none] p-[0] bg-[transparent] absolute top-[35px] left-[877px] rounded-[10px] shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] w-[144px] h-[38px] active:animate-[1s_ease_0s_1_normal_none_jello-horizontal] active:opacity-[1]"
      autoFocus
    >
      <button
